...
public class Bfast extends RichMapFunction<byte[], String> {
    ...
    public Bfast(String script) throws IOException {
        String localPath = "/tmp/" +UUID.randomUUID().toString() +".r";
        ...
        //get local script path name
        this.script = localPath;
        fs.close();
    }
    ...
    public String runBfast(String inputFile) throws IOException,
        ...
        String command = "Rscript " +script +" 0.06 harmonic "
                + dates + " " + inputFile;
