...
public class Bfast extends RichMapFunction<byte[], String> {
    private static final long serialVersionUID = 1L;

    @Override
    public String map(byte[] value) throws Exception {
        String tempFilePath = "/tmp/" +UUID.randomUUID().toString() +".Rdata";
        Path path = Paths.get(tempFilePath);
        Files.write(path, value);
        return runBfast(tempFilePath);
    }

    public static String runBfast(String inputFile) throws IOException,
        ...
        String command = "Rscript files/bfast_java.r 0.06 harmonic "
                + dates + " " + inputFile;
