...
public class BfastParametersTest extends RichMapFunction<byte[], String> {
    ...
    public String runBfast(String inputFile) throws IOException,
        ...
        //Compare several script files running bfast
        List<String> scriptsFile = new ArrayList<String>();
        scriptsFile.add("/home/savio/workspace/remote_sensing_pipeline/files/bfast_luis_wavelet_java.r");
        scriptsFile.add("/home/savio/workspace/remote_sensing_pipeline/files/bfast_luis_java.r");
