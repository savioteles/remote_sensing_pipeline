...
public class BfastParametersTest extends RichMapFunction<byte[], String> {
    ...
    private String scriptsFileInput;
    
    public BfastParametersTest(String scriptsFileInput) {
		super();
		this.scriptsFileInput = scriptsFileInput;
	}
    ...
    public String runBfast(String inputFile) throws IOException,
        ...
        String[] scriptsFile = scriptsFileInput.split(";");
        String output = "";
